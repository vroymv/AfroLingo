...
export default function Unit7ListeningDictationActivity({
  activity,
  onComplete,
}: Props) {
  useLessonProgressReporter();
  const { award } = useCompletionXP(15, "unit7-dictation");
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={async () => {
          await award({
            screen: "Unit7ListeningDictationActivity",
            reason: "completed",
...
export const componentKey = "unit7-listening-dictation";
