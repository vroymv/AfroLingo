...
export default function Unit7MatchingActivity({ activity, onComplete }: Props) {
  useLessonProgressReporter();
  const { award } = useCompletionXP(15, "unit7-matching");
...
export const componentKey = "unit7-matching";
