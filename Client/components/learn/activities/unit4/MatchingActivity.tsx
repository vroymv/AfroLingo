...
export default function GreetingsMatchingActivity({
  activity,
  onComplete,
}: Props) {
  useLessonProgressReporter();
  const { award } = useCompletionXP(15, "greetings-matching");
  ...
  return (
    <BaseMatchingActivity
      ...
      onComplete={async () => {
        await award({
          screen: "GreetingsMatchingActivity",
...
export const componentKey = "greetings-matching";
