...
import { DUMMY_AUDIO_URL, UNIT_6_THEME } from "./constants";
...
export default function Unit6VocabularyTableActivity({
  activity,
  onComplete,
}: Props) {
  useLessonProgressReporter();
  const { award } = useCompletionXP(10, "unit6-vocab");
  ...
  return (
    <BaseVocabularyTableActivity
      ...
      onComplete={async () => {
        await award({
          screen: "Unit6VocabularyTableActivity",
          reason: "completed",
...
export const componentKey = "unit6-vocabulary-table";
