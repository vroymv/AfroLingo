...
export default function Unit6MultipleChoiceActivity({
  activity,
  onComplete,
}: Props) {
  useLessonProgressReporter();
  const { award } = useCompletionXP(10, "unit6-mcq-complete");
    ...
    if (!showResult) {
      ...
      if (isCorrect && userId && !correctXPAwarded) {
        ...
        const result = await awardXP({
          ...
          sourceId: `unit6-mcq-correct-${sourceKey}`,
          metadata: {
            unitId,
            currentActivityNumber,
            totalActivities,
            screen: "Unit6MultipleChoiceActivity",
...
export const componentKey = "unit6-multiple-choice";
...
const styles = StyleSheet.create({
  ...
  optionSelected: {
    borderColor: UNIT_6_THEME.primary,
