...
export default function Unit5MatchingActivity({ activity, onComplete }: Props) {
  useLessonProgressReporter();
  const { award } = useCompletionXP(15, "unit5-matching");
...
export const componentKey = "unit5-matching";
