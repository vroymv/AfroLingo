...
export default function Unit5MultipleChoiceActivity({
  activity,
  onComplete,
}: Props) {
  useLessonProgressReporter();
  const { award } = useCompletionXP(10, "unit5-mcq-complete");
    ...
    if (!showResult) {
      ...
      if (isCorrect && userId && !correctXPAwarded) {
        ...
        const result = await awardXP({
          ...
          sourceId: `unit5-mcq-correct-${sourceKey}`,
          metadata: {
            unitId,
            currentActivityNumber,
            totalActivities,
            screen: "Unit5MultipleChoiceActivity",
...
export const componentKey = "unit5-multiple-choice";
...
const styles = StyleSheet.create({
  ...
  optionSelected: {
    borderColor: UNIT_5_THEME.primary,
