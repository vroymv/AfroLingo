...
const SUPPORTED_LANGUAGES: Language[] = [
  {
    ...
    description: "Spoken by 200M+ people across East Africa",
    flag: "🇹🇿",
  },
  {
    id: "zu",
    name: "Zulu",
    nativeName: "isiZulu",
    description: "Largest ethnic group in South Africa",
    flag: "🇿🇦",
  },
  {
    id: "ln",
    name: "Lingala",
    nativeName: "Lingála",
    description: "Trade language of Central Africa",
    flag: "🇨🇩",
  },
];
        ...
        >
          <View style={styles.headerContent}>
            ...
            <ThemedText style={styles.subtitle}>
              Which African language would you like to learn? Each offers unique
              cultural insights and beautiful linguistic patterns.
            </ThemedText>
          </View>
          ...
          <View style={styles.infoSection}>
            ...
            <ThemedText style={styles.infoText}>
              We&apos;ve chosen this starting set because they span different
              regions and cultural influences, letting you discover diverse
              linguistic patterns and connect with vibrant communities across
              Africa.
            </ThemedText>

            <View style={styles.benefitsList}>
              <View style={styles.benefitItem}>
                <ThemedText style={[styles.benefitIcon, { color: tintColor }]}>
                  ✨
                </ThemedText>
...
const styles = StyleSheet.create({
  ...
  languageFlag: { fontSize: 38, marginRight: 16 },
  languageNames: { flex: 1 },
  languageName: { fontSize: 20, marginBottom: 4, fontWeight: "600" },
  languageNativeName: { fontSize: 14, opacity: 0.65, fontStyle: "italic" },
  checkmark: {
    width: 28,
    height: 28,
    borderRadius: 14,
  ...
  languageDescription: { fontSize: 15, opacity: 0.8, lineHeight: 22 },
  infoSection: {
    marginTop: 40,
    marginBottom: 32,
    padding: 24,
  ...
  infoTitle: { marginBottom: 12, fontSize: 18 },
  infoText: { fontSize: 15, lineHeight: 22, opacity: 0.8, marginBottom: 16 },
  benefitsList: { gap: 12 },
  benefitItem: { flexDirection: "row", alignItems: "center", gap: 12 },
  benefitIcon: { fontSize: 16 },
  benefitText: { fontSize: 14, opacity: 0.8, flex: 1 },
